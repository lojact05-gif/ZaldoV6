...
<body>
                                        ...
                                        <div id="accOfficial" class="accordion-collapse collapse" data-bs-parent="#printAccordion">
                                            <div class="accordion-body">
                                                ...
                                                <div class="d-flex flex-wrap gap-2 mt-3">
                                                    <button type="button" class="small-btn" id="btnOfficialHealthCheck">Testar</button>
                                        ...
                                        <div id="accLegacy" class="accordion-collapse collapse" data-bs-parent="#printAccordion">
                                            <div class="accordion-body">
                                                ...
                                                <div class="row g-3 mt-1">
                                                    ...
                                                    <div class="col-lg-5">
                                                        <div class="z-status" style="margin-top:26px;">Offline? Execute a bridge e valide <code>http://127.0.0.1:9123/health</code></div>
                                                    </div>
                                                </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <ol class="z-modal-list">
                        ...
                        <li>Volte ao POS e clique em <strong>Testar</strong>.</li>
                    </ol>
    ...
    <script>
        (function () {
            ...
            // Bridge local (fallback legado) foi removido desta página.
            // Para testar manualmente: execute a bridge e valide http://127.0.0.1:9123/health
