...
public sealed class ReceiptPayload
{
    ...
    [JsonPropertyName("company_lines")]
    public List<string> CompanyLines { get; set; } = new();
    ...
    [JsonPropertyName("document_label")]
    public string DocumentLabel { get; set; } = string.Empty;

    [JsonPropertyName("document_number")]
    public string DocumentNumber { get; set; } = string.Empty;

    [JsonPropertyName("customer_line")]
    public string CustomerLine { get; set; } = string.Empty;

    [JsonPropertyName("table_line")]
    public string TableLine { get; set; } = string.Empty;
    ...
    public List<ReceiptTaxPayload> TaxLines { get; set; } = new();
    ...
    [JsonPropertyName("final_feed_lines")]
    public int FinalFeedLines { get; set; } = 6;
}
...
public sealed class ReceiptTaxPayload
{
    [JsonPropertyName("label")]
    public string Label { get; set; } = string.Empty;
...
public sealed class FiscalPdfPrintRequest
{
